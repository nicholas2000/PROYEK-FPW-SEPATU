...
<body>
    ...
    <div class="contentAdmin">
        ...
        <form action="/editbarang">
            ...
            nama barang <input type="text" name="nama_barang" placeholder="nama barang"
            ...
            kategori <input type="number" name="kategori" placeholder="id kategori" value="{{ $barang->Kategori }}">
            <br>
